...
const faqs = [
  {
    question: 'What services does Hewlett Printers Solution!  offer?',
    answer:
      'Hewlett Printers Solution! offers a wide range of services including printer setup, troubleshooting, repair, and maintenance for all types of printers.',
  },
  {
    question: 'Can Hewlett Printers Solution help with wireless printer setup?',
    answer:
  ...
  {
    question:
      'How much does Hewlett Printers Solution charge for a service call?',
    answer:
...
const FAQAccordion = () => {
  ...
  return (
    <main className="bg-white text-[#0f766e] p-6">
      <section className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col gap-4">
          {faqs.map((faq, index) => (
            ...
            >
              <div
                className="flex justify-between items-center p-4 cursor-pointer bg-[#f5f5f5]"

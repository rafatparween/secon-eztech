...
const ComputerService = () => {
  return (
    <main className="bg-[#f5f5f5] py-6 px-6">
      <h2 className="text-[#0f766e] text-2xl font-semibold mb-4">Computers</h2>
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 border p-6 bg-white h-80">
        <ul className="py-10">
          ...
          <li className="flex items-center mb-4">
            <Link to="/computersetup" className="flex items-center">
              <ManageAccountsIcon className="text-[#0f766e] mr-2" />
              <p>Email or Online Account Setup or Support</p>
            </Link>
          </li>
          <li className="flex items-center mb-4">
            <Link to="/computersetup" className="flex items-center">
              <MonitorIcon className="text-[#0f766e] mr-2" />
              <p>New Computer Setup</p>
            </Link>
          </li>
          <li className="flex items-center mb-4">
            <Link to="/computersetup" className="flex items-center">
              <SettingsIcon className="text-[#0f766e] mr-2" />
              <p>OS (Operating System) Install or Re-install</p>
            </Link>
          </li>
          <li className="flex items-center mb-4">
            <Link to="/computersetup" className="flex items-center">
              <InstallDesktopIcon className="text-[#0f766e] mr-2" />
        ...
        <ul className="py-10">
          ...
          <li className="flex items-center mb-4">
            <Link to="/computersetup" className="flex items-center">
              <BuildIcon className="text-[#0f766e] mr-2" />
              <p>Computer Repair & Help</p>
            </Link>
          </li>
          <li className="flex items-center mb-4">
            <Link to="/computersetup" className="flex items-center">
              <SettingsBackupRestoreIcon className="text-[#0f766e] mr-2" />
              <p>Data Back-up or Transfer</p>
            </Link>
          </li>
          <li className="flex items-center mb-4">
            <Link to="/computersetup" className="flex items-center">
              <AcUnitIcon className="text-[#0f766e] mr-2" />
              <p>Virus Removal & Cleanup</p>
            </Link>
          </li>
          <li className="flex items-center mb-4">
            <Link to="/computersetup" className="flex items-center">
              <SchoolIcon className="text-[#0f766e] mr-2" />

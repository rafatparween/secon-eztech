    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F766E] to-black text-white mt-[60px]">
      ...
      <header className="bg-[#0F766E] border-b border-teal-700">
        <div className="max-w-4xl mx-auto px-4 py-12 text-center">
          <h1 className="text-5xl font-bold mb-6">About Us – Hewlett Printers Solution LLC</h1>
          <p className="text-xl text-teal-100 leading-relaxed">
            At Hewlett Printers Solution LLC, we believe technology should work for you—not against you. We are a U.S.-based remote technical support company specializing in printer services, computer troubleshooting, wireless setup, driver installation, antivirus protection, and device optimization. Our certified support experts provide fast, secure, and reliable technical help to customers across the United States and Canada.
          </p>
          <p className="text-xl text-teal-100 leading-relaxed mt-6">
            With years of experience in the support industry, we have helped thousands of customers get their printers and computers running smoothly again—saving time, reducing frustration, and improving productivity. Whether you're a home user, small business, or professional office, we provide on-demand remote support you can trust.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-4xl font-bold text-teal-300">What We Do</h2>
          </div>
          <p className="text-lg text-gray-200 mb-8">
            We provide complete remote technical support services, including:
          </p>
          <div className="grid md:grid-cols-2 gap-4 ml-8">
            ...
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Printer troubleshooting & error resolution</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Wireless and network printer configuration</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Driver installation and software support</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Slow computer and performance issues</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Antivirus installation and system protection</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Connection and device compatibility support</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Remote support plans for individuals and businesses</p>
            </div>
          </div>
          <p className="text-lg text-gray-200 mt-8">
            All services are provided remotely, which means you get fast assistance without waiting for a technician to visit your location.
          </p>
        </section>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <span className="text-3xl text-green-400">✅</span>
            <h2 className="text-4xl font-bold text-teal-300">Why Choose Us</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-4 ml-8">
            <div className="flex items-start">
              <span className="text-green-400 mr-3 mt-1">✔</span>
              <p className="text-gray-200">U.S.-based professional support experts</p>
            </div>
            <div className="flex items-start">
              <span className="text-green-400 mr-3 mt-1">✔</span>
              <p className="text-gray-200">Certified & experienced technicians</p>
            </div>
            <div className="flex items-start">
              <span className="text-green-400 mr-3 mt-1">✔</span>
              <p className="text-gray-200">Safe and secure remote assistance</p>
            </div>
            <div className="flex items-start">
              <span className="text-green-400 mr-3 mt-1">✔</span>
              <p className="text-gray-200">Quick response and fast solutions</p>
            </div>
            <div className="flex items-start">
              <span className="text-green-400 mr-3 mt-1">✔</span>
              <p className="text-gray-200">24/7 technical availability</p>
            </div>
            <div className="flex items-start">
              <span className="text-green-400 mr-3 mt-1">✔</span>
              <p className="text-gray-200">Honest pricing – no hidden fees</p>
            </div>
            <div className="flex items-start">
              <span className="text-green-400 mr-3 mt-1">✔</span>
              <p className="text-gray-200">Customer-first service approach</p>
            </div>
          </div>
          <p className="text-lg text-gray-200 mt-8">
            We deliver solutions the right way—with integrity, transparency, and professionalism.
          </p>
        </section>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <span className="text-3xl text-green-400">✅</span>
            <h2 className="text-4xl font-bold text-teal-300">Our Mission</h2>
          </div>
          <p className="text-lg text-gray-200">
            Our mission is simple: to make technology simple and reliable for everyone. We help people solve everyday technical problems quickly, safely, and affordably—so they can focus on what really matters.
          </p>
        </section>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <span className="text-3xl text-green-400">✅</span>
            <h2 className="text-4xl font-bold text-teal-300">Our Vision</h2>
          </div>
          <p className="text-lg text-gray-200">
            To become one of the most trusted remote support companies in North America by delivering exceptional customer service, high-quality solutions, and dependable support every time.
          </p>
        </section>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <span className="text-3xl text-green-400">✅</span>
            <h2 className="text-4xl font-bold text-teal-300">Our Core Values</h2>
          </div>
          <div className="space-y-4 ml-8">
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200"><span className="font-semibold">Trust & Transparency</span> – Honest service and clear communication</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200"><span className="font-semibold">Customer Commitment</span> – Your satisfaction is our priority</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200"><span className="font-semibold">Reliability</span> – Fast and consistent technical support</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200"><span className="font-semibold">Security First</span> – Your privacy and data safety matter to us</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200"><span className="font-semibold">Service Excellence</span> – Professional help you can rely on</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <span className="text-3xl text-green-400">✅</span>
            <h2 className="text-4xl font-bold text-teal-300">Who We Serve</h2>
          </div>
          <p className="text-lg text-gray-200 mb-6">
            We proudly provide support to:
          </p>
          <div className="grid md:grid-cols-2 gap-4 ml-8">
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Home users</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Students & remote workers</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Small businesses</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Offices & professional teams</p>
            </div>
            <div className="flex items-start">
              <span className="text-teal-400 mr-3 mt-1">•</span>
              <p className="text-gray-200">Non-technical users who need expert guidance</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <span className="text-3xl text-green-400">✅</span>
            <h2 className="text-4xl font-bold text-teal-300">Get Help Today</h2>
          </div>
          <p className="text-lg text-gray-200 mb-8">
            If you're facing printer problems, setup issues, software errors, or computer slowdowns—we're here to help. Our technicians are ready to assist you with fast remote support you can count on.
          </p>
          <div className="bg-teal-800/30 p-8 rounded-2xl border border-teal-600">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-lg">
              <div className="flex items-center gap-3">
                <span className="text-2xl">📞</span>
                <span className="font-semibold">Call Us: (866) 866-6257</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-2xl">📧</span>
                <span className="font-semibold">Email: support@hewlettprinterssolution.com</span>
              </div>
            </div>
          </div>
          <p className="text-lg text-gray-200 text-center mt-8 font-semibold">
            ✅ Experience smart, simple, and secure technical support.
          </p>
        </section>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-4xl font-bold text-teal-300">Legal Notice</h2>
          </div>
          <p className="text-lg text-gray-200">
            Hewlett Printers Solution LLC is an independent service provider offering remote technical support. We are not affiliated with or endorsed by any printer or computer brand. All trademarks and brand names are the property of their respective owners.
          </p>
        </section>
      </main>
    </div>
